...
FLAGS := -fsanitize=address -Wall -Wextra -Wno-unused-parameter -g -Wno-switch
LIBS := -ldiscord -lcurl
...
backup_discord_bot: main.o master_record.o master_config.o msg_scraper.o weather_scraper.o utils.o
	$(CC) $^ -o $@ $(LIBS)
...
msg_scraper.o: msg_scraper.c msg_scraper.h master_record.h
	$(CCO) $< -o $@
weather_scraper.o: weather_scraper.c weather_scraper.h
	$(CCO) $< -o $@
